...
In the **Notebooks** folder, there are also three sub-folders for each analysis, including 12 ipynb files, recording analysis procedures comprehensively, such as creating visualizations, calculating frequencies, installing the **Brahe-AWQ** LLM to output narrative elements and calculating **BERTScores**.
